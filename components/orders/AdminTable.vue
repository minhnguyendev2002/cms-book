                    ...
                    <a-dropdown :trigger="['click']">
                        ...
                        <a-menu slot="overlay">
                            <a-menu-item @click="$refs.BookDialog.open(scope, true)">
                                <i class="w-4 mr-2 isax isax-eye" />
                                Xem chi tiết
                            </a-menu-item>
                            <a-menu-item v-if="scope.status === STATUS.WATTING" class="!text-success-900">
                                <i class="w-4 mr-2 isax isax-check" />
                                Đồng ý
                            </a-menu-item>
                            <a-menu-item v-if="scope.status === STATUS.WATTING || scope.status === STATUS.DELIVERY " class="!text-danger-900" @click="$refs.ConfirmDialog.open()">
...
<script>
    ...
    import { STATUS, STATUS_OPTIONS } from '@/constants/order/admin';
